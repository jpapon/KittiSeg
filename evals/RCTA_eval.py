        ...
        for i, datum in enumerate(file):
                ...
                if True:
                    ...
                    if (image.shape[2] == 1):
                      ...
                      color_image = image
                    ov_image = seg.make_overlay(color_image, class_score_im)
                    ...
                    label_im = utils.overlay_segmentation(color_image, label_im, label_colors)
                ...
                class_gt = gt_image[:,:,class_of_interest] > 0
